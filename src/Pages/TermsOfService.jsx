...
export default function TermsOfService() {
  return (
    <section className="min-h-screen pt-28 pb-16 px-6" id="TermsOfService">
      <div className="site-max mx-auto bg-themeCardBg border border-themeBorder p-8 rounded-2xl shadow-xs">
        <h1 className="text-3xl font-extrabold text-themeText font-serif italic mb-6">Terms of Service</h1>
        ...
        <h3 className="text-xl font-bold text-themeText font-serif italic mt-8 mb-4">Use License</h3>
        <p className="text-md text-themeTextMuted mb-4">
        ...
        <h3 className="text-xl font-bold text-themeText font-serif italic mt-8 mb-4">Disclaimer</h3>
        <p className="text-md text-themeTextMuted mb-4">
        ...
        <h3 className="text-xl font-bold text-themeText font-serif italic mt-8 mb-4">Limitations</h3>
        <p className="text-md text-themeTextMuted mb-4">
